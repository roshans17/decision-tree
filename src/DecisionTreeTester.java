...
public class DecisionTreeTester<G extends ITreeGenerator<D>, D extends IDataset> {
    ...
    private static final String MUSHROOMS_TRAINING = MUSHROOMS_BASE + "training.csv.csv";
    ...
    private static final String VILLAINS_TRAINING = VILLAINS_BASE + "training.csv.csv";
    ...
    private static final String CANDIDATES_TRAINING_GENDER_EQUAL =
        CANDIDATES_BASE + "training.csv-gender-equal.csv";
    private static final String CANDIDATES_TRAINING_GENDER_UNEQUAL =
        CANDIDATES_BASE + "training.csv-gender-unequal.csv";
    private static final String CANDIDATES_TRAINING_GENDER_CORRELATED =
        CANDIDATES_BASE + "training.csv-gender-correlated.csv";
    ...
    private static final String SONG_TRAINING = SONG_BASE + "training.csv.csv";
    ...
    /**
     * Generates our own tree structure from the training.csv data that
     ...
     * the tree. Because this dataset is the training.csv dataset on which the tree
     * was generated, this list of root-to-leaf paths is enough to regenerate
     * the entire tree.
     *
     * @param trainingData the training.csv data used to generate
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Accuracy on training.csv data: " + accuracy);
